...
def main(code):
    ...
    if code == 1: #full house and pair  test
    ...
    elif code == 7: # ace low straight test
        sesh.players[0].hand[0] = Card('S',14)
        sesh.players[0].hand[1] = Card('C',2)
        ...
        sesh.COMMUNITY_CARDS[4] = Card('C',10)
    elif code == 8: # straight flush test
        sesh.players[0].hand[0] = Card('S',14)
        ...
        sesh.COMMUNITY_CARDS[3] = Card('D',6)
        sesh.COMMUNITY_CARDS[4] = Card('C',10)
    elif code == 9: # straight flush test - double card value numbers
        ...
        sesh.COMMUNITY_CARDS[3] = Card('D',7)
        sesh.COMMUNITY_CARDS[4] = Card('C',10)
    elif code == 10: # royal flush test 1
        sesh.players[0].hand[0] = Card('D',10)
    ...
    elif code == 11: # royal flush test 2
        sesh.players[0].hand[0] = Card('D',10)
        sesh.players[0].hand[1] = Card('D',12)
        sesh.players[1].hand[0] = Card('C',6)
        sesh.players[1].hand[1] = Card('C',2)
        ...
        code = 99 #play a random game

    if 1 <= code <= 99: # use these codes for hand ranking tests
        sesh.showState()
